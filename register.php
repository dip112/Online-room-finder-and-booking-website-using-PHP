...
<?php
    ...
    if (isset($_REQUEST['username'])) {
        ...
        $query    = "INSERT into `tbl_user` (user_name, user_mobile , user_address , user_aadhaar, user_password)
                     VALUES ('$username', '$mobile','$address','$adhar','" . md5($password) . "')";
...
?>
    <form class="form" action="" method="post">
        ...
        <input type="text" class="login-input" name="adhar" placeholder="Adhar Number">
