...
--
-- Host: localhost:3307
-- Generation Time: Jun 27, 2023 at 08:36 PM
...
INSERT INTO `tbl_room` (`room_id`, `room_title`, `room_type`, `room_price`, `room_location`, `room_srch_key_words`, `isBooked`, `room_owner_user_id`, `isDeleted`) VALUES
(1, 'Rudra Vila', 1, 2000, 'Front of MAKAUT', 'makaut , single', 0, 1, 0),
...
CREATE TABLE `tbl_user` (
  ...
  `user_aadhaar` varchar(15) NOT NULL,
...
INSERT INTO `tbl_user` (`user_id`, `user_name`, `user_mobile`, `user_address`, `user_aadhaar`, `user_password`, `isAdmin`, `isDeleted`) VALUES
(2, 'Subhankar Barman', '8918095764', 'Gazole', '2222222222222', '81dc9bdb52d04dc20036dbd8313ed055', 0, 0),
(3, 'Dipankar Roy', '8967392427', 'Dakshin Dinajpur', '2222222222222', '81dc9bdb52d04dc20036dbd8313ed055', 1, 0);
